...
# Create Application
nios2-app-generate-makefile --bsp-dir $BSP_DIR/${BSP}_0 --elf-name ${APP}_0.elf --src-dir src_0/ --set APP_CFLAGS_OPTIMIZATION -O3
...
# Create Application
nios2-app-generate-makefile --bsp-dir $BSP_DIR/${BSP}_$i --elf-name ${APP}_$i.elf --src-dir src_$i/ --set APP_CFLAGS_OPTIMIZATION -O3
